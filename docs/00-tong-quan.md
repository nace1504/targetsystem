...
| 04 | `04-technical-design.md` | Chi tiết kỹ thuật đầy đủ để code thẳng: schema/API từng field, rule severity, 7 kịch bản, network/deploy, test fixtures, system prompt LLM, Tool Service, tracing, lớp ingest, DB schema, error envelope — đọc TRƯỚC khi code bất kỳ module nào |
