...
*Cây tài liệu tham khảo nhanh: đọc file này → cần yêu cầu/phạm vi xem `01` → cần kiến trúc/kịch bản tấn công xem `02` → cần biết đã làm đến đâu xem `03` → cần đối chiếu tài liệu gốc dự án tổng xem `source/`.*
